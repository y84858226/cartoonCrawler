...
/**
 * Created by Jzhung on 2017/2/27. 文档图片水印处理
 */
public class ImageConverter {
	...
	public static void main(String[] args) {
		...
		/*
		 * String dir = "E:\\data\\Desktop"; String saveDir =
		 * "E:\\data\\Desktop-convert";
		 */

		// replaceFolderImages(dir);
		/*
		 * String srcFile = "E:\\data\\image\\img38.png"; String dstFile =
		 * "E:\\data\\image\\img38.png"; long begin = System.currentTimeMillis();
		 * repleaceColor(srcFile, dstFile); long time = System.currentTimeMillis() -
		 * begin; System.out.println(time);
		 */
	}
